...
export const appURL = 'http://meem.app/api/';
export const couponURL = 'http://meem.app/api/coupon/';
export const messageSuccess = 'thank you .. your coupon has been successfully added to your order .. please procceed to checkout page';
