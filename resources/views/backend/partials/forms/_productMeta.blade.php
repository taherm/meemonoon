...
<div class="form-body">
    ...
    'elementOne' => Form::textarea('description_ar',old('description_ar') ,['class' => 'form-control','required' => 'required']),
    'labelTow' => 'description_en*' ,
    'elementTow' => Form::textarea('description_en',old('description_en'),['class' => 'form-control','required' => 'required'])
    ])
    ...
    'labelTow' => 'notes_en*' ,
     'elementTow' => Form::textarea('notes_en',old('notes_en'),['class' => 'form-control','required' => 'required'])
    ])
