...
<div class="form-body">
    ...
    <div class="form-group col-lg-12 text-left small">
        ...
        <div class="mt-checkbox-list">
            <div class="col-lg-4">
                <label class="mt-checkbox"> {{ trans('general.home_delivery_availability') }}
                    {!! Form::checkbox('home_delivery_availability',true, old('home_delivery_availability'),['class' => 'form-control']) !!}
                    <span></span>
                </label>
                <label class="mt-checkbox"> {{ trans('general.shipment_availability') }}
                    {!! Form::checkbox('shipment_availability', true,old('shipment_availability'),['class' => 'form-control']) !!}
                    <span></span>
                </label>
            </div>
            <div class="col-lg-4">
                <label class="mt-checkbox"> {{ trans('general.on_homepage') }}
                    {!! Form::checkbox('on_homepage', true,old('on_homepage'),['class' => 'form-control']) !!}
                    <span></span>
                </label>
            </div>
            <div class="col-lg-2">
