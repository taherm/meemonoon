                            ...
                            <table cellspacing="0" cellpadding="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="item-col quantity" style="text-align:right; padding-right: 10px; border-top: 1px solid #cccccc;">
                                        ...
                                        {!! (isset($coupon) && $coupon->value > 0) ? '<span class="total-space">Coupon Value :</span>' : null !!}<br />
                                        {!! (isset($coupon) && $coupon->value > 0) ? '<span class="total-space">After Coupon :</span>' : null !!}<br />
                                    ...
                                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                                        ...
                                        {!! (isset($coupon) && $coupon->value > 0) ? '<span class="total-space">'.$couponDiscountValue .'KD</span>' : null !!}<br />
                                        {!! (isset($coupon) && $coupon->value > 0) ? '<span class="total-space">'.$amountAfterCoupon .'KD</span>' : null !!}<br />
